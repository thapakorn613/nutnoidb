...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 26, 2019 at 12:41 AM
...
INSERT INTO `project` (`id`, `project_name`, `teacher_id1`, `teacher_id2`, `teacher_id3`, `send_email`) VALUES
(1, 'Banana Marathon', 1, 2, 3, 1),
(2, 'virtual reality human anatomy', 4, 5, 6, NULL),
(3, 'Program to Develop Reading in Junior High School Students with Learning Disability', 5, 4, 1, NULL),
(4, ' Fantasy Grand Arena', 5, 6, 1, NULL),
(5, 'Learning and Development Application Through PSP', 5, 4, 6, NULL),
(6, 'Service Queuing Application', 5, 3, 2, NULL),
(7, 'NutNoi', 1, 6, 2, NULL);
...
INSERT INTO `teacher` (`id`, `name`, `email`, `teamup`, `googlecalendar`, `count2`) VALUES
(1, 'lachana', 'lachana@cmu.com', 'https://teamup.com/ksd952dt39h2ar9gxy', 'lachana@gmail.com', 0),
(2, 'sakgasit', 'sakgasit@cmu.com', 'https://teamup.com/ksq7w7hu9f4c8697tm', 'sakgasit@gmail.com', 0),
(3, 'narissara', 'narissara@cmu.com', 'https://teamup.com/ksfyc2gdssiofnmzy8', 'narissara@gmail.com', 0),
(4, 'narathip', 'narathip@cmu.com', 'https://teamup.com/ksfyc2gdssiofnmzy8', 'narathip@gmail.com', 0),
(5, 'juggapong', 'juggapong@cmu.com', 'https://teamup.com/ksq7w7hu9f4c8697tm', 'juggapong@gmail.com', 0),
(6, 'patiwet', 'patiwet@cmu.com', 'https://teamup.com/ksd952dt39h2ar9gxy', 'patiwet@gmail.com', 0);
...
(2, 'art', NULL, 1, 'art@gmail.com', '$2y$10$/v.UBoB4qeWd7ho8QNSCX.zwfJHgT4dlzE52UZrSUGCV9id2Or6PK', NULL, 'admin', 'm7Jxc6vcUvjrAJd48q2hXRACWLmCtHALJiYMDGzZYnfKkFurS2eZSLIJZaPY', '2019-03-21 02:56:25', '2019-03-27 02:44:42'),
(3, 'thapakorn', 3, 1, 'thapakorn@gmail.com', '$2y$10$6HWcUrQp9aFq3yfAwFhgWuU/PXIo8rgQ94M1WBPzSzQDXWidlMly2', 1, NULL, 'lyEPjd2FWDdXoDOflfGswrnubCr0dcGqgZEpsgt443nSfUSwwB6RzFlKDrrz', '2019-03-21 11:11:15', '2019-03-27 02:44:17'),
(4, 'green', NULL, 1, 'green@gmail.com', '$2y$10$UuAuOlmNKjgxzTD6MG1SlOEEivNe6OYq1FvndMW8Sn6FOjEFRpCyG', 3, NULL, 'BQKiNCDxODUUMhZDsa9w5UzIN0xkPWEnTuHg4816khLKTWXWmA8hJfZwCDye', '2019-03-27 01:54:53', '2019-03-27 01:54:53'),
(6, 'kan', NULL, NULL, 'kan@gmail.com', '$2y$10$MYQWBJF3QJrrudlxda1lzuadR2/mGF6lpLuMhrsRNawHaAQsBoPvi', NULL, NULL, 'efiw1qAqHUEu6dH7bVfJmJfcuRKak1XTVyCkZKFpQJGSlSj2elviPT6Rg7yS', '2019-04-25 14:50:15', '2019-04-25 14:50:15');
...
--
ALTER TABLE `waitconfirm`
  MODIFY `wait_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
